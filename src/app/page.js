...
export default function Home() {
  ...
  return (
    <main className="flex-1 flex flex-col bg-gradient-to-b from-background to-muted/30">
      <div className="relative flex-1">
        <div className="container mx-auto px-4 md:px-6 2xl:max-w-[1400px] pt-24 pb-20 md:pt-32 md:pb-24">
          <div className="grid gap-12 md:grid-cols-2 md:gap-16 items-center">
            ...
            <div className="relative pb-12">{/* added padding for controls */}
              ...
              {/* Controls positioned within wrapper without negative offset */}
