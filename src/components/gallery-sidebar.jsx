    ...
    <div className="w-80 flex flex-col space-y-6 p-4 border-l border-border">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <ImageImporter
            onImageAdd={addImageFromUrl}
            onImageRemove={removeImage}
            recentImages={imageOrder}
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <NumberInput
            ...
            onValueChange={(value) => updateControl('columns', value)}
            min={1}
            max={8}
            stepper={1}
            className="w-full"
        ...
        <div className="space-y-2">
          ...
          <NumberInput
            id="gap"
            value={controls.gap}
            onValueChange={(value) => updateControl('gap', value)}
            min={0}
            max={100}
            stepper={5}
            className="w-full"
        ...
        <div className="space-y-2">
          ...
          <NumberInput
            ...
            onValueChange={(value) => updateControl('repeat', value)}
            min={1}
            max={10}
            stepper={1}
            className="w-full"
        ...
        <div className="space-y-2">
          ...
          <ColorPicker
            ...
            onChange={(value) => updateControl('borderColor', value)}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <NumberInput
            id="borderThickness"
            value={controls.borderThickness}
            onValueChange={(value) => updateControl('borderThickness', value)}
            min={0}
            max={20}
            stepper={1}
            className="w-full"
        ...
        <div className="space-y-2">
          ...
          <NumberInput
            id="borderOpacity"
            value={controls.borderOpacity}
            onValueChange={(value) => updateControl('borderOpacity', value)}
            min={0}
            max={1}
            decimalScale={2}
            stepper={0.05}
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Drag and drop images to reorder them. Click the X button to remove an image.
        </p>
        ...
        <div className="space-y-2">
          <ImageSortable
            ...
            onImageOrderChange={setImageOrder}
            onImageRemove={removeImage}
            columns={3}
          />
        </div>
