...
export function IsometricControls({ controls, updateControl, resetControl, imageOrder, loadSampleImages, handleFileUpload, addImageFromUrl, removeImage, setImageOrder, resetView, recalculateBounding, onCapture, onHighlightImage, isLoadingImages }) {
